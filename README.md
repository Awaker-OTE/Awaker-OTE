...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A local-first desktop app for quick capture, managed Markdown notebooks, and reusable ChatGPT/Codex context.</p>
      <p><sub>Rust · Tauri · macOS</sub></p>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <p>A reading workflow plugin for MarginNote 4.</p>
      <p><sub>JavaScript · MarginNote 4</sub></p>
      <p>
